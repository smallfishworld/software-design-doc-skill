...
Apply [diagram-standards.md](diagram-standards.md) for diagram semantics and acceptance. Follow [diagram-guide.md](diagram-guide.md) for tool selection, actual rendering checks, PlantUML-to-Mermaid fallback, source/SVG/PNG asset ownership, Markdown references, DOCX compatibility fallback, and Windows handoff. Keep these concerns in their respective references rather than duplicating them here.
